...
options["--snap-folder"] = [PATH_TO_DATA_FROM_EXEC + "snap_ad-hoc_slice/"]
...
snap_folder = "data/snap_ad-hoc_slice/"
slice_folder = "data/slice_ad-hoc_slice/"
...
print(f"\nAd-hoc slice extraction completed in {elapsed_time:.4f} seconds.\n")
