 ...
 public:
  ...
  void validate() const
  {
    ...
    if (ppmColormap != "viridis" && ppmColormap != "jet" &&
      ...
      throw std::runtime_error(
          "ppm-colormap must be: viridis, jet, coolwarm, or grayscale");
    ...
    opts.add_options()("o,order", "Order of approximation",
        ...
        ("save-snapshot", "Save snapshots during the simulation",
         cxxopts::value<bool>(o.saveSnapshot))(
            "snap-folder",
            "Folder to save snapshots (default = current folder)",
            cxxopts::value<string>(o.snapFolder))(
            "snap-interval",
            "Step interval between snapshots save (default = 50)",
            cxxopts::value<int>(o.snapInterval))

        // Sismogrammes
        ("sismo-file", "Sismo file for source definition",
         cxxopts::value<string>(o.sismoFile))(
            "sismo-folder", "Folder where sismo file is located",
        ...
        // PPM Visualization
        ("save-ppm", "Enable PPM visualization (in-situ image generation)",
         cxxopts::value<bool>(o.savePPM))(
            "ppm-folder",
            "Folder to save PPM images (default = current folder)",
            cxxopts::value<string>(o.ppmFolder))(
            "ppm-interval", "Step interval between PPM images (default = 50)",
            cxxopts::value<int>(o.ppmInterval))(
            "ppm-plane", "Slice plane: xy, xz, or yz (default = xy)",
            cxxopts::value<string>(o.ppmPlane))(
            "ppm-slice-index", "Position of the slice (0 = automatic center)",
            cxxopts::value<int>(o.ppmSliceIndex))(
            "ppm-colormap",
            "Colormap: viridis, jet, coolwarm, grayscale (default = viridis)",
            cxxopts::value<string>(o.ppmColormap))

        // Compression
        ("use-compression", "Enable data compression for snapshots",
         cxxopts::value<bool>(o.useCompression))(
            "compression-bits",
            "Quantization bits: 8, 16, or 32 (default = 16)",
            cxxopts::value<int>(o.compressionBits))(
            "use-rle", "Enable Run-Length Encoding (RLE) compression",
            cxxopts::value<bool>(o.useRLE))(
